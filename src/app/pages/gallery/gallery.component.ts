  ...
  ngOnInit(): void {
    ...
    this.events = [
      this.createAlbum(
        ...
        [
          {
            src: 'assets/images/Boys_And_Girls/IMG_6750.png',
          ...
          {
            src: 'assets/images/Boys_And_Girls/IMG_6737.png',
            alt: "Luke Checking A Student's Code",
            caption: 'Luke Checking Code',
            event: 'UWL | Boys and Girls Club',
          },
          {
            src: 'assets/images/Boys_And_Girls/IMG_6745.png',
      ...
      this.createAlbum(
        ...
        [
          {
            src: 'assets/images/CookiesCODERS/IMG_6956.png',
          ...
          {
            src: 'assets/images/CookiesCODERS/IMG_7013.png',
            alt: 'Oreos!!!',
            caption: 'Oreos!!!',
            event: 'Cookies With CODERS | Weekly Event',
          },
          {
            src: 'assets/images/CookiesCODERS/IMG_7008.png',
      ...
      this.createAlbum(
        ...
        [
          {
            src: 'assets/images/KidsCollege/IMG_0875.png',
      ...
      this.createAlbum(
        ...
        [
          {
            src: 'assets/images/TrickOrTreat24/IMG_6144.jpg',
          ...
          {
            src: 'assets/images/TrickOrTreat24/IMG_6146.jpg',
            alt: 'Jack being Jack',
