  ...
  ngOnInit(): void {
    ...
    this.events = [
      this.createAlbum(
        ...
        [
          {
            src: 'assets/images/boys-and-girls/IMG_6750.png',
          ...
          {
            src: 'assets/images/boys-and-girls/IMG_6737.png',
            alt: "Luke Checking A Student's Code",
            caption: 'Luke Checking Code',
            event: 'UWL | Boys and Girls Club',
          },
          {
            src: 'assets/images/boys-and-girls/IMG_6745.png',
      ...
      this.createAlbum(
        ...
        [
          {
            src: 'assets/images/cookies-with-coders/IMG_6956.png',
          ...
          {
            src: 'assets/images/cookies-with-coders/IMG_7013.png',
            alt: 'Oreos!!!',
            caption: 'Oreos!!!',
            event: 'Cookies With CODERS | Weekly Event',
          },
          {
            src: 'assets/images/cookies-with-coders/IMG_7008.png',
      ...
      this.createAlbum(
        ...
        [
          {
            src: 'assets/images/kids-college/IMG_0875.png',
      ...
      this.createAlbum(
        ...
        [
          ...
          {
            src: 'assets/images/trick-or-treat/2024/IMG_6146.jpg',
            alt: 'Jack being Jack',
